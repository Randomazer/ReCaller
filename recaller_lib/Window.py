...
import logging
logger = logging.getLogger('recaller_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by RecallerWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseRecallerWindow object.
        """
        builder = get_builder('RecallerWindow')
        new_object = builder.get_object("recaller_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a RecallerWindow object with it in order to finish
        initializing the start of the new RecallerWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.recaller")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('recaller')
        except ImportError:
            pass
        ...
        try:
            from recaller import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for recaller."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for recaller."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the RecallerWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the RecallerWindow is closed."""
